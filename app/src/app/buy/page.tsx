  ...
  return (
    <Layout>
      <div className="space-y-6">
        <h1 className="text-2xl font-bold text-gray-900">Buy LORE Tokens</h1>
          ...
          <div>
            ...
            <div className="bg-white shadow rounded-lg p-6 mt-6">
              ...
              <div className="text-sm text-gray-600 space-y-3">
                <p>
                  LORE tokens are sold via a bonding curve, which means the price increases as more tokens are bought.
                </p>
                <p>
                  1. Enter the amount of ETH you want to spend
                </p>
                <p>
                  2. Review the number of LORE tokens you'll receive
                </p>
                <p>
                  3. Select your slippage tolerance
                </p>
                <p>
                  4. Click "Buy Tokens" to complete your purchase
                </p>
                <p className="text-xs mt-4">
                  Note: The bonding curve ensures price discovery through market forces. 
                  As more tokens are purchased, the price per token gradually increases.
                </p>
              </div>
            </div>
          </div>
